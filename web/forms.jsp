...
<jsp:useBean id="obj1" class="model.insert"/>
...
<%
    ...
    if(url!=null)
    {
        obj1.insert(url, c, d, e, f, g, h, i, j, k, l, m, n);
...
<script src="js/lumino.glyphs.js"></script>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active"><a href="forms.jsp"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg>Add New Domain</a></li>
			</ul>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add Domains</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Domain Elements</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form">
								...
								<div class="form-group">
									<label>URL</label>
                                                                        ...
                                                                        <label>Linked</label>
                                                                        <input name="linked" class="form-control" placeholder="linked" >
                                                                        <label>Alexa</label>
									<input name="alexa" class="form-control" placeholder="alexa" value="">
                                                                        <label>DA</label>
									<input name="DA"  class="form-control" placeholder="DA" >
                                                                        <label>MR</label>
									<input name="MR" class="form-control" placeholder="MR" >
                                                                        <label>ML</label>
									<input name="ML" class="form-control" placeholder="ML" >
                                                                        <label>FB</label>
									<input name="FB" class="form-control" placeholder="FB" >
								</div>
							...
							<div class="col-md-6">
									...
									<input name="go" class="form-control" placeholder="Google+1" >
                                                                        <label>LinkedIn</label>
									<input name="lin" class="form-control" placeholder="LinkedIn" >
                                                                        <label>Pinterest</label>
									<input name="pin" class="form-control" placeholder="Pinterest" >
                                                                        <label>Dmoz</label>
									<input name="dmoz" class="form-control" placeholder="Dmoz" >
                                                                        <label>wayback</label>
									<input name="wayback" class="form-control" placeholder="wayback" >
                                                                        <label>Price</label>
								...
								<button type="reset" class="btn btn-default">Reset All Values</button>
                                                                <input name="passid" type="hidden" value="0">
							</div>
						</form>
					</div>
				</div>
