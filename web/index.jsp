<%-- 
    Document   : index.jsp
    Created on : Aug 21, 2016, 3:49:28 PM
    Author     : Usama Jamil
--%>
...
<script src="js/lumino.glyphs.js"></script>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="manageusers.jsp"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Settings</a></li>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
                        <li class="active"><a href="#"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> DashBoard</a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="canvas-wrapper">
							<canvas class="main-chart" id="line-chart" height="15" width="600"></canvas>
						</div>
					</div>
				</div>
			</div>
