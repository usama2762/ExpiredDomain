...
<jsp:useBean id="obj" class="model.edomainsmodel"/> 
            ...
            <!-- #fh5co-header -->
             ...
             <div class="container" align="right">
                            ...
                            <div class="fh5co-left-position">
                                <p class="animate-box"> <a href="#" id="btnCart" class="btn btn-primary">Move to cart</a></p>
                            </div>
            </div>
            <!-- END #fh5co-subscribe -->
            <%
...
<table id="example" class="display" cellspacing="0" width="100%">
      ...
      <tfoot id="simple">
        ...
        <tr>
            ...
            <td>
                <div class="mkrnaqeebi" id="<%=domainlist.get(j).id %>">
                         <img src="images/index.jpg"  width="40px" height="40px">
                     </div>
            </td>
            </tr>
            <% j++;} %>
        ...
        <script>
            ...
            $('#btnCart').click(function(event){
                    event.preventDefault();
                    window.location = '/expireddomain/cart.jsp?id='+arr.toString();
                });
        </script>
