<%-- 
    Document   : widgets
    Created on : Aug 21, 2016, 4:44:41 PM
    Author     : Usama Jamil
--%>
...
<script src="js/lumino.glyphs.js"></script>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li ><a href="tables.jsp"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Domains</a></li>
			<li class="active"><a href="#"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Widgets</a></li>
			
			<li><a href="charts.jsp"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Charts</a></li>
			<li><a href="forms.jsp"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg>Entry Forms</a></li>
